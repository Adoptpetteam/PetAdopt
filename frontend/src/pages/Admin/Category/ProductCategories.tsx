...
const ProductCategories: React.FC = () => {
  ...
  const [editingCategory, setEditingCategory] = useState<IProductCategory | null>(null);
  ...
  const handleOpenEditModal = (record: IProductCategory) => {
  ...
  const columns: ColumnsType<IProductCategory> = [
    ...
    },
    {
      title: "Loại",
      dataIndex: "type",
      render: () => <Tag color="green">Product</Tag>
    },
    {
      title: "Hành động",
      width: 150,
    ...
    <div className="p-6 bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 min-h-screen">
      ...
      >
        <Form form={form} layout="vertical" onFinish={onFinish} className="mt-4">
          ...
          >
            <Input placeholder="Ví dụ: Thức ăn cho chó, Đồ chơi cho mèo..." size="large" />
          </Form.Item>
