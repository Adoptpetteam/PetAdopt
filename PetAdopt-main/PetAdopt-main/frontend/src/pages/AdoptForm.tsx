...
export default function AdoptForm() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto py-20 px-6">
      <h1 className="text-3xl font-bold text-[#6272B6] text-center mb-10">Đăng ký nhận nuôi</h1>

      <div className="grid grid-cols-2 gap-10">
        <div className="bg-white rounded-2xl shadow p-6">
          <img src={pet.image} className="w-full h-[300px] object-cover rounded-xl mb-4" />

          <h2 className="text-xl font-bold text-[#6272B6] mb-4">{pet.name}</h2>
        ...
        <div className="bg-white rounded-2xl shadow p-8 space-y-6">
          ...
          <button onClick={handleNext} className="w-full bg-[#6272B6] text-white py-3 rounded-full hover:bg-[#4e5fa8] transition">
            Tiếp tục
          </button>
        </div>
      </div>
